...
<script>
    ...
    function initContent() {
        $("#contentTypeTable").bootstrapTable({
            ...
            columns:[
                ...
                {field:'cz',title:'操作',align:'center',width:150,formatter:function (index,row,value) {
                   return '<button type="button" onclick="updType()" class="btn btn-default">修改</button>';
                }}
            ]
        })
    }
